          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form-horizontal" action="update-pengunjung-aksi.php" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php echo $data['nama_pengunjung'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Perbarui Tanggal Kunjungan (Opsional)</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" name="jk" value="Laki-Laki" required <?php if($data['jenis_kelamin'] == 'Laki-Laki') echo 'checked' ?>> Laki-Laki
                                <input type="radio" name="jk" value="Perempuan" required <?php if($data['jenis_kelamin'] == 'Perempuan') echo 'checked' ?>> Perempuan
                            </div>
                        </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            oninvalid="this.setCustomValidity('Testimoni pengunjung harus diisi')" oninput="setCustomValidity('')"
                            ><?php echo $data['testimoni']; ?></textarea>
                        </div>
                    </div>
